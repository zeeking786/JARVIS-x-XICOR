...
class Widget:
    def __init__(self):
            ...
            self.userText.set('मेरी आज्ञा देने के लिए \ सुनना शुरू करें पर क्लिक करें')
            ...
            btn = Button(root, text='सुनना शुरू करें', font=('Black ops one', 10, 'bold'), bg='deepSkyBlue', fg='white',command=self.assistant).pack(fill='x', expand='no')
            btn2 = Button(root, text='बंद करे', font=('Black Ops One', 10, 'bold'), bg='deepSkyBlue', fg='white',command=root.destroy).pack(fill='x', expand='no')
            btn3 = Button(root, text='भाषा बदलें', font=('Black Ops One', 10, 'bold'), bg='deepSkyBlue', fg='white',command=self.changeLang).pack(fill='x', expand='no')
    ...
    def assistant(self):
                        ...
                        while True:
                                if query == 0: 
                                        ...
                                        codePath = 'D:\Jarvis\check\JarvisHindi1.txt' 
                                        ...
                                        toaddr = "chaubeynikki99@gmail.com"
                                        msg = MIMEMultipart() 
                                        msg['From'] = fromaddr 
                                        msg['To'] = toaddr 
